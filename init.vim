...
" Mapping that yanks current file name to + register
...
" CtrlSF Bindings and Settings - {{{
let g:ctrlsf_default_root = 'project'
nnoremap <leader>csf :CtrlSF 
nnoremap <leader>cst :CtrlSFToggle<CR>
" }}}

" Copilot Bindings {{{
nnoremap <leader>tt <plug>(copilot-suggest) 
" }}}

" Fuzzy Finder Bindings {{{
nnoremap <leader>ft :FuzzyOpen<CR>
" }}}
